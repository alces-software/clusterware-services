...
# the number of processing slots required.  For example
# `mpislots-verbose 2` will allocate 2 processing slots for the job.
#
# Note that requesting a larger number of slots will mean that your
# job could take longer to launch.
#
#$ -pe mpislots-verbose 2
